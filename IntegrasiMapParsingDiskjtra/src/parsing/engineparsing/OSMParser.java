...
//			//System.out.println(nodesList.item(i));
//			if(nodesList.item(i).getNodeName().equals("node")){
//				NamedNodeMap atts=nodesList.item(i).getAttributes();
//				System.out.println(atts.getNamedItem("id").getNodeValue().toString());
//				//parseTags(nodesList.item(i).getChildNodes());
//			}
//		}
//		System.exit(0);
		OSM osm = new OSM();
